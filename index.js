...
app.use("/api/usuarios",cors(corsOptions), (req, res) => {
  res.json(usuariosDB);
});

app.use("/api/predios",cors(corsOptions), (req, res) => {
  res.json(prediosDB);
});

app.use("/api/semillas",cors(corsOptions), (req, res) => {
  res.json(semillasDB);
});

app.use("/api/cultivos",cors(corsOptions), (req, res) => {
  res.json(cultivosDB);
});

app.use("/api/perfil",cors(corsOptions), (req, res) => {
  res.json(perfilDB);
});
